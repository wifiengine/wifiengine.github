...
//setting the light mode's image
var day = document.createElement("IMG");
day.src = "img/day.jpg";
day.style.width = "15px";
day.style.height = "15px";
day.style.marginLeft = "20px";
darkbutton.appendChild(day);


//setting the dark mode's image
var night = document.createElement("IMG");
night.src = "img/night.jpg";
night.style.width = "15px";
night.style.height = "15px";
night.style.marginLeft = "20px";
...
mailbutton.onmouseenter = function() {
    ...
    mailbutton.style.borderBottomRightRadius = "20px";
    mailbutton.style.borderBottomLeftRadius = "20px";
}
mailbutton.onmouseleave = function() {
    //mailbutton.style.opacity = "1";
    mailbutton.style.borderRadius = "0px";
    mailbutton.style.borderBottomLeftRadius = "0px";
}   
...
youtube.onmouseenter = function() {
    ...
    youtube.style.borderBottomRightRadius = "20px";
    youtube.style.borderBottomLeftRadius = "20px";
}
youtube.onmouseleave = function() {
    //youtube.style.opacity = "1";
    youtube.style.borderBottomRightRadius = "0px";
    youtube.style.borderBottomLeftRadius = "0px";
}
*/
//redirect to youtube
...
darkbutton.onmouseenter = function() {
    ...
    darkbutton.style.borderBottomRightRadius = "20px";
    darkbutton.style.borderBottomLeftRadius = "20px";
}
darkbutton.onmouseleave = function() {
    //darkbutton.style.opacity = "1";
    darkbutton.style.borderBottomRightRadius = "0px";
    darkbutton.style.borderBottomLeftRadius = "0px";
}
*/
...
download.style.background = colors[col];

//download button being hovered over
...
draw.textAlign = "center";
draw.fillStyle = "#ffffff";
draw.fillText("Level: " + level,650,30);
...
//runs popup
window.onscroll = function() {setInterval(popupfunc,1000);};


function popupfunc() {
    popuptimer+= 0.1;
    h1.innerHTML = popuptext.substr(0,popuptimer);
